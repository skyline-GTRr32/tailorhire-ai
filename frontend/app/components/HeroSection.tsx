      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-screen flex items-center justify-center">
        <div className="text-center w-full py-20">
          ...
          >
            ...
            <h1 className="responsive-h1 font-bold text-white mb-6 leading-tight">
            ...
            <p className="responsive-body text-white/90 max-w-4xl mx-auto leading-relaxed px-4">
          ...
          <motion.div
            ...
            className="responsive-grid-3 gap-6 md:gap-8 mb-12 px-4"
          >
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-pink-400 mb-2">
                  {stat.number}
                </div>
                <div className="text-white/80 text-xs sm:text-sm md:text-base lg:text-lg">
                  {stat.label}
                </div>
              </motion.div>
            ))}
